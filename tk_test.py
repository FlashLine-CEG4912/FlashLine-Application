...
bottomframeB= Frame(root,bg="white", pady=20)
...
nbwaiting = Label(topframe,bg="white",height=8, width=30,
                  font=("Helvetica",12,"bold"), text=waitingStr)


nbnextavailable = Label(topframe,bg="white",height=8, width=30,
...
nbservedNUM = Label(middleframe, bg="#BBDEFB",height=2, width=10,
                font=("Helvetica",50,"bold"),text=nowServing)


#button
button1 = Button(bottomframeB, command=pickATicket, bg= '#448AFF', text="Pick a ticket", fg="white")
